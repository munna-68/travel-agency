    ...
    <div className={styles.page}>
      ...
      <section className={styles.featureGrid}>
        <article className={styles.cardLarge}>
          <CropImage
            src={heroImage}
            alt="Autumn temple gate in Kyoto"
            position="24% 37%"
            ratio="1.62 / 1"
          />
        ...
        <article className={styles.cardTall}>
          <CropImage
            src={heroImage}
            alt="Glacier valley and turquoise lake"
            position="80% 30%"
            ratio="0.88 / 1"
          />
      ...
      <section className={styles.secondaryGrid}>
        <article className={styles.cardLarge}>
          <CropImage
            src={heroImage}
            alt="River winding through Guilin"
            position="44% 69%"
            ratio="1.1 / 1.15"
          />
          <div className={styles.cardCopy}>
        ...
        <article className={styles.callout}>
          ...
          <p>
            Experience the caldera without the crowds. Our new nighttime journal
            explores the secret life of the Cyclades under the moonlight.
          </p>
          <div className={styles.calloutFooter}>
            <strong>COMING FALL ’24</strong>
            <button type="button" aria-label="Open reveal">
              ↗
            </button>
          </div>
        </article>
